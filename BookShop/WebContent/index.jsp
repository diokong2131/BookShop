                        ...
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><a href="index.jsp">Home</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="index.jsp">Home version 02</a></li>
                    ...
                    <div class="off-canvas-contact-widget">
                        <ul>
                            <li><i class="fa fa-mobile"></i>
                                <a href="#">010.8888.7777</a>
                            </li>
                            <li><i class="fa fa-envelope-o"></i>
                                <a href="#">Yedam@Yeye.com</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="hero-slider-content slide-1">
                                        <span>Best Selling Last Year</span>
                                        <h1>The Having 더 해빙</h1>
                                        <h2>40만부 판매 기념 리오더</h2>
                                        <a href="shop.html" class="btn-hero">Buy now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
